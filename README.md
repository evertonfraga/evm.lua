...
- [x] Nested call context (CALL/CALLCODE/DELEGATECALL/STATICCALL/CREATE/CREATE2)
- [x] Gas metering (per-opcode, shared call-tree pool, configurable `GAS_CAP`, default 8M)

## Opcodes implemented: 149/149
|||||||||||||  |  |  |  |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
